...
void AmphoraInterface::LoadUserFile() {
  ...
  bool loadusers = mediator_m->Load(AmphoraType::User);
  if (loadusers) {
...
void AmphoraInterface::LoadCryptoConfig() {
  ...
  // TODO
  bool loaded = mediator_m->Load(AmphoraType::Crypto);
  if (loaded) {
...
void AmphoraInterface::LoadAccountFile() {
  ...
  // TODO
  // make sure that user is logged in first
  bool loadaccounts = mediator_m->Load(AmphoraType::Account);
  if (loadaccounts) {

...
std::string User::get_username() const { return User::username_m; }

std::string User::get_password() const { return User::password_m; }

std::string User::get_datecreated() const { return User::datecreated_m; }

std::string User::get_datemodified() const { return User::datemodified_m; }

template <typename Archive> inline void User::serialize(Archive &ar) {
  ar(User::username_m, User::password_m, User::datecreated_m,
     User::datemodified_m);
}

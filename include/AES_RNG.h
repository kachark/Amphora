...
// source:://www.cryptopp.com/wiki/RandomNumberGenerator#Test_Suite_and_GlobalRNG

// Implements random number generator which takes a seed derived from the operating system
...
public:
  ...
  void GenerateIntoBufferedTransformation(BufferedTransformation &target, const std::string &channel, CryptoPP::lword size)
  {
    if (!m_keyed) {
